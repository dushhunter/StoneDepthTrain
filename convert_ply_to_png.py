...
try:
    ...
    HAS_TRIMESH = False
    print("Warning: trimesh not available, falling back to basic plotting")
...
def render_ply_to_png(ply_path, output_path, width=12, height=9):
    ...
    if HAS_TRIMESH:
        ...
        try:
            ...
            print(f"Error with trimesh: {e}")
            return
    else:
        # Fallback: read PLY manually and plot points
        print("Using basic PLY reader...")
        vertices = read_ply_simple(ply_path)
